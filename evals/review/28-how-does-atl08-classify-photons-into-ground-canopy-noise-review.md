...
> Companion to `28-how-does-atl08-classify-photons-into-ground-canopy-noise-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `how does ATL08 classify photons into ground canopy noise`
**Labeled corpus:** `nsidc`
**Panel signature:** `be1188e8374f` — do not edit; identifies the result
