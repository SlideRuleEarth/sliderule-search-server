...
> Companion to `30-atl24-pointnet-bathymetric-photon-classification-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL24 PointNet++ bathymetric photon classification`
**Labeled corpus:** `nsidc`
**Panel signature:** `2f9025cff660` — do not edit; identifies the result
