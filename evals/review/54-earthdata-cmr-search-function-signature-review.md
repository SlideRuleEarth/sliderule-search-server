...
> Companion to `54-earthdata-cmr-search-function-signature-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `earthdata CMR search function signature`
**Labeled corpus:** `docsearch`
**Panel signature:** `1ea76ecd83a3` — do not edit; identifies the result
