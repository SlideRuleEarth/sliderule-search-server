...
> Companion to `41-atl06-data-groups-structure-for-land-ice-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL06 data groups structure for land ice`
**Labeled corpus:** `nsidc`
**Panel signature:** `70572d61c9b7` — do not edit; identifies the result
