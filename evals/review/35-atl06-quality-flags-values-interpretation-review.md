...
> Companion to `35-atl06-quality-flags-values-interpretation-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL06 quality flags values interpretation`
**Labeled corpus:** `nsidc`
**Panel signature:** `d3aaa7215f24` — do not edit; identifies the result
