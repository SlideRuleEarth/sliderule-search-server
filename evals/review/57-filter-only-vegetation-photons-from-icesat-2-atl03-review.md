...
> Companion to `57-filter-only-vegetation-photons-from-icesat-2-atl03-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `filter only vegetation photons from ICESat-2 atl03`
**Labeled corpus:** `docsearch`
**Panel signature:** `4a66f59a011b` — do not edit; identifies the result
