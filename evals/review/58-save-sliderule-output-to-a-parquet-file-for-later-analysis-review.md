...
> Companion to `58-save-sliderule-output-to-a-parquet-file-for-later-analysis-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `save sliderule output to a parquet file for later analysis`
**Labeled corpus:** `docsearch`
**Panel signature:** `6f42ee744ca0` — do not edit; identifies the result
