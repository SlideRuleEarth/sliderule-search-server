...
> Companion to `32-atl03-geophysical-corrections-ocean-tides-solid-earth-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL03 geophysical corrections ocean tides solid earth`
**Labeled corpus:** `nsidc`
**Panel signature:** `9ffabd7001ab` — do not edit; identifies the result
...
- section: 
- pages: 
- notes: This surfaced the right section but the info was in a table
