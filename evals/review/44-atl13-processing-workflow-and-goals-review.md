...
> Companion to `44-atl13-processing-workflow-and-goals-results.md`. Open both side-by-side;
...
- section: 
- pages: 
- notes: "broad-scope: entire ATBD covers this query; URL-only match by design"
