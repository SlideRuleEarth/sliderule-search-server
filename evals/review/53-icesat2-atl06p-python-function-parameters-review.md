...
> Companion to `53-icesat2-atl06p-python-function-parameters-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `icesat2 atl06p python function parameters`
**Labeled corpus:** `docsearch`
**Panel signature:** `0d492d95bff9` — do not edit; identifies the result
