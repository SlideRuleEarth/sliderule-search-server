...
> Companion to `36-atl08-terrain-classification-output-variables-hdf5-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL08 terrain classification output variables HDF5`
**Labeled corpus:** `nsidc`
**Panel signature:** `6cc99603a8e6` — do not edit; identifies the result
