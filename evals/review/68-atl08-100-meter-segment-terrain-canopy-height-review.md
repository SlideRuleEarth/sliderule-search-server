...
> Companion to `68-atl08-100-meter-segment-terrain-canopy-height-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL08 100-meter segment terrain canopy height`
**Labeled corpus:** `nsidc`
**Panel signature:** `d890f2b0f44d` — do not edit; identifies the result
