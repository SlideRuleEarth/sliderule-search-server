...
> Companion to `66-atl03-pointing-biases-beam-geolocation-error-model-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL03 pointing biases beam geolocation error model`
**Labeled corpus:** `nsidc`
**Panel signature:** `132d1c480dbc` — do not edit; identifies the result
