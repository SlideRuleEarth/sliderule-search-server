...
> Companion to `60-sliderule-api-deprecation-breaking-removed-old-function-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `sliderule api deprecation breaking removed old function`
**Labeled corpus:** `docsearch`
**Panel signature:** `35be16bb1081` — do not edit; identifies the result
