...
> Companion to `33-atl08-canopy-height-calculation-method-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL08 canopy height calculation method`
**Labeled corpus:** `nsidc`
**Panel signature:** `56aaf02420d2` — do not edit; identifies the result
