...
> Companion to `39-gedi-l4a-footprint-geolocation-variables-agbd-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `GEDI L4A footprint geolocation variables AGBD`
**Labeled corpus:** `nsidc`
**Panel signature:** `81003caeee97` — do not edit; identifies the result
