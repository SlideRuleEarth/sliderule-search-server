...
> Companion to `48-atlas-laser-altimeter-instrument-specifications-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATLAS laser altimeter instrument specifications`
**Labeled corpus:** `nsidc`
**Panel signature:** `44c5ab4d3557` — do not edit; identifies the result
