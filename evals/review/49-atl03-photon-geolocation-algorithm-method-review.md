...
> Companion to `49-atl03-photon-geolocation-algorithm-method-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL03 photon geolocation algorithm method`
**Labeled corpus:** `nsidc`
**Panel signature:** `4bf2b6db8c10` — do not edit; identifies the result
