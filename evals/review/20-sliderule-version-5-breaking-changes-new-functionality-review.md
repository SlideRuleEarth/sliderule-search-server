...
> Companion to `20-sliderule-version-5-breaking-changes-new-functionality-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `sliderule version 5 breaking changes new functionality`
**Labeled corpus:** `docsearch`
**Panel signature:** `33fac049ec0d` — do not edit; identifies the result
