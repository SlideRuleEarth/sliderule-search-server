...
> Companion to `65-gedi-laser-channels-power-modes-beam-configuration-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `GEDI laser channels power modes beam configuration`
**Labeled corpus:** `nsidc`
**Panel signature:** `0441fc16d92c` — do not edit; identifies the result
