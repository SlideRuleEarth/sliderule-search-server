...
> Companion to `59-phoreal-added-sliderule-release-notes-version-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `phoreal added sliderule release notes version`
**Labeled corpus:** `docsearch`
**Panel signature:** `0ace35ec6482` — do not edit; identifies the result
...
- corpus: 
- url: https://docs.slideruleearth.io/developer_guide/release_notes/release-2023-03-03-v02-01-00.html
- section: 
- pages: 
- notes: 
