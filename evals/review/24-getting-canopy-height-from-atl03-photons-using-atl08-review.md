...
> Companion to `24-getting-canopy-height-from-atl03-photons-using-atl08-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `getting canopy height from atl03 photons using atl08`
**Labeled corpus:** `docsearch`
**Panel signature:** `2f00f2fc1b2e` — do not edit; identifies the result
