...
> Companion to `42-atl08-dragann-noise-filtering-algorithm-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL08 DRAGANN noise filtering algorithm`
**Labeled corpus:** `nsidc`
**Panel signature:** `517b6d4aae21` — do not edit; identifies the result
