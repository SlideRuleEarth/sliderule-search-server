...
```
GEDI Project Homepage Earthdata GEDI Project Overview ATBD for GEDI Waveform Geolocation for L1 and L2 Products Previous Next © Copyright 2020â2026, University of Washington. Build v5.4.2 . Built with Sphinx using a theme provided by Read the Docs .
```
