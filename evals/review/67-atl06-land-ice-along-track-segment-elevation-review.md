...
> Companion to `67-atl06-land-ice-along-track-segment-elevation-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL06 land ice along-track segment elevation`
**Labeled corpus:** `nsidc`
**Panel signature:** `217aab84ce49` — do not edit; identifies the result
