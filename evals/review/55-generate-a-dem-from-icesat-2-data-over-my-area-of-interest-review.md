...
> Companion to `55-generate-a-dem-from-icesat-2-data-over-my-area-of-interest-results.md`. Open both side-by-side;
...
- section: 
- pages: 
- notes: The prompt is deliberately underspecified and ambiguous
