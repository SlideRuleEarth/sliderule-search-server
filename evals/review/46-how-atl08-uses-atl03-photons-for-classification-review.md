...
> Companion to `46-how-atl08-uses-atl03-photons-for-classification-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `how ATL08 uses ATL03 photons for classification`
**Labeled corpus:** `nsidc`
**Panel signature:** `55bf5472e98b` — do not edit; identifies the result
