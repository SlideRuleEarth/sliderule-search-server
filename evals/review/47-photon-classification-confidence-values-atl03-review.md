...
> Companion to `47-photon-classification-confidence-values-atl03-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `photon classification confidence values ATL03`
**Labeled corpus:** `nsidc`
**Panel signature:** `073407bef3b6` — do not edit; identifies the result
