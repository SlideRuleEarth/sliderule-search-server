...
> Companion to `09-how-to-use-sliderule-python-client-install-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `how to use SlideRule Python client install`
**Labeled corpus:** `docsearch`
**Panel signature:** `6b03d4080f7a` — do not edit; identifies the result
