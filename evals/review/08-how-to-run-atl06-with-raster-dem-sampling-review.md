...
> Companion to `08-how-to-run-atl06-with-raster-dem-sampling-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `how to run atl06 with raster DEM sampling`
**Labeled corpus:** `docsearch`
**Panel signature:** `54c76ffe81f6` — do not edit; identifies the result
