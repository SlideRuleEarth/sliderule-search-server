...
> Companion to `26-how-does-atl03-signal-finding-algorithm-work-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `how does ATL03 signal finding algorithm work`
**Labeled corpus:** `nsidc`
**Panel signature:** `49036d5eeded` — do not edit; identifies the result
...
- section: 
- pages: 
- notes: The query is so broad the whole document answers it
