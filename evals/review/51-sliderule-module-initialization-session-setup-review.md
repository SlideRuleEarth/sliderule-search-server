...
> Companion to `51-sliderule-module-initialization-session-setup-results.md`. Open both side-by-side;
...
- corpus: 
- url: https://docs.testsliderule.org/api_reference/sliderule.html#init
- section: 
- pages: 
- notes: 
