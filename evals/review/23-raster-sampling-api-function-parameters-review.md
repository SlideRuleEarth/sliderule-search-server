...
> Companion to `23-raster-sampling-api-function-parameters-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `raster sampling API function parameters`
**Labeled corpus:** `docsearch`
**Panel signature:** `2006e2b0edfd` — do not edit; identifies the result
...
- corpus: 
- url: https://docs.slideruleearth.io/user_guide/raster_sampling.html#parameters
- section: 
- pages: 
- notes: the full answer was chunked across two responses
