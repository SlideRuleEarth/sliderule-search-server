...
> Companion to `43-atl24-ensemble-classification-bathymetry-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL24 ensemble classification bathymetry`
**Labeled corpus:** `nsidc`
**Panel signature:** `48addb12e88f` — do not edit; identifies the result
