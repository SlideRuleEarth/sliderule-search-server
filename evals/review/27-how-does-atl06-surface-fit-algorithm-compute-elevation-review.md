...
> Companion to `27-how-does-atl06-surface-fit-algorithm-compute-elevation-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `how does ATL06 surface fit algorithm compute elevation`
**Labeled corpus:** `nsidc`
**Panel signature:** `95543d5f44a7` — do not edit; identifies the result
...
- corpus: 
- url: https://docs.slideruleearth.io/user_guide/icesat2.html#atl06-sr-algorithm
- section: 
- pages: 
- notes: The surface fit algorithm is a SlideRule server function
