...
> Companion to `12-output-sliderule-results-as-geoparquet-format-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `output SlideRule results as GeoParquet format`
**Labeled corpus:** `docsearch`
**Panel signature:** `c1fbb231a9cc` — do not edit; identifies the result
