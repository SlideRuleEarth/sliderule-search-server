...
> Companion to `19-yapc-added-to-sliderule-version-release-notes-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `yapc added to sliderule version release notes`
**Labeled corpus:** `docsearch`
**Panel signature:** `47f97cbe2b4c` — do not edit; identifies the result
...
- section: 
- pages: 
- notes: The YAPC was introduced in v1.4.6 August 2022 but the release notes from then are not accessible (sliderule had a different domain then)
