...
> Companion to `38-atl24-file-contents-and-spatial-coverage-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL24 file contents and spatial coverage`
**Labeled corpus:** `nsidc`
**Panel signature:** `57f85e3ea7bb` — do not edit; identifies the result
