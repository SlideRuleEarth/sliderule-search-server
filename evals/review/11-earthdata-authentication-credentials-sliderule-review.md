...
> Companion to `11-earthdata-authentication-credentials-sliderule-results.md`. Open both side-by-side;
...
- corpus: 
- url:https://docs.slideruleearth.io/developer_guide/how_tos/accessing_earthdata_cloud.html 
- section: 
- pages: 
- notes: 
