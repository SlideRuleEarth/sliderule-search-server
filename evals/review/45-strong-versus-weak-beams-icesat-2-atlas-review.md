...
> Companion to `45-strong-versus-weak-beams-icesat-2-atlas-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `strong versus weak beams ICESat-2 ATLAS`
**Labeled corpus:** `nsidc`
**Panel signature:** `3f23b7b02cf5` — do not edit; identifies the result
