...
> Companion to `34-atl03-hdf5-file-structure-data-groups-photon-fields-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL03 HDF5 file structure data groups photon fields`
**Labeled corpus:** `nsidc`
**Panel signature:** `a32d93cbd07e` — do not edit; identifies the result
