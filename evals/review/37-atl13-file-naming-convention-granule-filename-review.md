...
> Companion to `37-atl13-file-naming-convention-granule-filename-results.md`. Open both side-by-side;
> this file is your editable form.

**Query:** `ATL13 file naming convention granule filename`
**Labeled corpus:** `nsidc`
**Panel signature:** `6e6b9840d0e6` — do not edit; identifies the result
